...
import { signInWithGoogle, signUpWithGoogle, checkUserExists, checkUsernameExists } from "@/lib/auth"; // Update your imports
...
const RegisterPage: React.FC = () => {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      const { user } = await signInWithGoogle(); // Sign in with Google, which returns a user object
